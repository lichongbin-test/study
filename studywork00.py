...
4.windows下试用相对路径可能会出现资源无法打开的报错，可以试用绝对路径。123
'''
...
def add_num(picPath,num):
    ...
    myfont = ImageFont.truetype('D:\\pythonproject\\test1\\YouSheBiaoTiHei-2.ttf',fontsize)
    ImageDraw.Draw(img).text((position,0), str(num), font=myfont, fill='red')
    img.save('D:\\pythonproject\\test1\\icon_with_num.jpg')

if __name__ == '__main__':
    picPath = 'D:\\pythonproject\\test1\\heidan.jpg'
    num = 99
    add_num(picPath,num)